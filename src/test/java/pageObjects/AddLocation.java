...
public class AddLocation {
	...
	public void addLocation() {
		...
		ClickListener.moveToElement(myUtils.returnElement("xpath", "//span[contains(text(),'--Select One--')]")).click()
				.sendKeys(myXl.getCellData(env, 35, 1)).sendKeys(Keys.ENTER).build().perform();
		myUtils.returnElement("id", "location").sendKeys(myXl.getCellData(env, 40, 1));
