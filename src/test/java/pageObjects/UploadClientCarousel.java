...
public class UploadClientCarousel {
	WebDriver driver;
	...
	public UploadClientCarousel(WebDriver driver) {
		this.driver = driver;
	...
	public void uploadClientCarousel()
	{
		myUtils.returnElement("xpath", "//a[@href='load-uploadClientCarousel']//img[@id='rcorners2']").click();
		myUtils.returnElement("id", "carousel").sendKeys("C:\\Users\\Raghu\\Desktop\\testlogo.png");
