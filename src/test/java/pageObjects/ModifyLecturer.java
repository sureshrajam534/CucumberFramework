...
public class ModifyLecturer {
	...
	public ModifyLecturer(WebDriver driver) {
		this.driver = driver;
	...
	public void modifyLecturer() {
		...
		myUtils.returnElement("xpath", "//a[contains(text(),'MODIFY LECTURER')]").click();
		myUtils.returnElement("id", "selectloc2").click();
		myUtils.returnElement("id", "studentformlist2.firstname").clear();
		myUtils.returnElement("id", "studentformlist2.firstname").sendKeys(myXl.getCellData(env, 28, 1));
