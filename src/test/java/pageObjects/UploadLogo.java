...
public class UploadLogo {
	...
	{
		myUtils.returnElement("xpath", "//a[@href='load-uploadClientlogo']//img[@id='rcorners2']").click();
		myUtils.returnElement("id", "clientlogo").sendKeys("C:\\Users\\Raghu\\Desktop\\testlogo1.png");
		myUtils.returnElement("xpath", "//input[@value='UPLOAD']").click();
